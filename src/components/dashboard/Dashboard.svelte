<script lang="ts">
  ...
  const stats = [
    { name: 'Terrains', value: '5', icon: 'terrain', color: 'bg-green-100 text-green-800' },
    { name: 'Espaces de culture', value: '12', icon: 'grid_view', color: 'bg-blue-100 text-blue-800' },
    { name: 'Cultures actives', value: '24', icon: 'grass', color: 'bg-amber-100 text-amber-800' },
    { name: 'Actions planifiées', value: '16', icon: 'event_note', color: 'bg-purple-100 text-purple-800' }
  ];
  ...
  const upcomingEvents = [
    ...
    {
      id: 3,
      title: 'Traitement préventif pommiers',
  ...
  <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
    <div>
      ...
      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
        Voici un aperçu de votre exploitation aujourd'hui
      </p>
    </div>
  ...
  <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
      ...
      <div class="p-6 text-center">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Ensoleillé</p>
        <div class="mt-6 grid grid-cols-3 gap-3 border-t border-gray-200 dark:border-gray-700 pt-4">
          <div>
            <p class="text-xs text-gray-500 dark:text-gray-400">Humidité</p>
            <p class="text-sm font-medium text-gray-900 dark:text-white mt-1">45%</p>
          </div>
          <div>
            <p class="text-xs text-gray-500 dark:text-gray-400">Vent</p>
            <p class="text-sm font-medium text-gray-900 dark:text-white mt-1">10 km/h</p>
          </div>
          <div>
            <p class="text-xs text-gray-500 dark:text-gray-400">Précipitations</p>
